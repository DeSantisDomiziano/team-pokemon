<div class="col-6 h-100">
  <ul class="list_pokemon p-0 m-0 list-unstyled">
      ...
      <li class="mb-1 {{ $index + 1 === $selectedPokemon[0] -> id ? 'active' : '' }}">
          <a class="text-dark d-flex justify-content-between align-items-center text-decoration-none" href="{{ route('selectedPokemon', $index) }}">
