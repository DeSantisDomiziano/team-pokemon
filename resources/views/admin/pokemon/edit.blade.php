...
<div class="container py-5 bg-dark-subtle rounded-4 my-4">
    ...
    @method('PUT')
        ...
        <div class="mb-3">
          ...
          <input type="text" name="type_1" id="type_1" class="form-control @error('type_1') is-invalid @enderror" placeholder="" aria-describedby="helpId" value="{{ old('type_1', $pokemon->type_1) }}" required>
        ...
        <div class="mb-3">
          ...
          <input type="text" name="type_2" id="type_2" class="form-control @error('type_2') is-invalid @enderror" placeholder="" aria-describedby="helpId" value="{{ old('type_2', $pokemon->type_2) }}" required>
        ...
        <div class="mb-3">
          ...
          <input type="number" name="total" id="total" class="form-control @error('total') is-invalid @enderror" placeholder="" aria-describedby="helpId" value="{{ old('total', $pokemon->total) }}" required>
        ...
        <div class="mb-3">
          ...
          <input type="number" name="hp" id="hp" class="form-control @error('hp') is-invalid @enderror" placeholder="" aria-describedby="helpId" value="{{ old('hp', $pokemon->hp) }}" >
        ...
        <div class="mb-3">
          ...
          <input type="number" name="attack" id="attack" class="form-control @error('attack') is-invalid @enderror" placeholder="" aria-describedby="helpId" value="{{ old('attack', $pokemon->attack) }}" >
        ...
        <div class="mb-3">
          ...
          <input type="number" name="defense" id="defense" class="form-control @error('defense') is-invalid @enderror" placeholder="" aria-describedby="helpId" value="{{ old('defense', $pokemon->defense) }}" >
          <small id="helpId" class="text-muted">Add kind of book</small>
          @error('defense')
            <div class="alert alert-danger">{{ $message }}</div>
          @enderror
        ...
        <div class="mb-3">
          ...
          <input type="number" name="sp_atk" id="sp_atk" class="form-control @error('sp_atk') is-invalid @enderror" placeholder="" aria-describedby="helpId" value="{{ old('sp_atk', $pokemon->sp_atk) }}" >
          <small id="helpId" class="text-muted">Add kind of book</small>
          @error('sp_atk')
            <div class="alert alert-danger">{{ $message }}</div>
          @enderror
        ...
        <div class="mb-3">
          ...
          <input type="number" name="sp_def" id="sp_def" class="form-control @error('sp_def') is-invalid @enderror" placeholder="" aria-describedby="helpId" value="{{ old('sp_def', $pokemon->sp_def) }}" >
          <small id="helpId" class="text-muted">Add kind of book</small>
          @error('sp_def')
            <div class="alert alert-danger">{{ $message }}</div>
          @enderror
